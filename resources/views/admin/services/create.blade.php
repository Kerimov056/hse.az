...
<div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
  <div>
    <h1 class="mb-1">Yeni Service</h1>
    <div class="input-help">Bu hissədə yalnız <span class="badge bg-success-subtle text-success border border-success badge-type">Service</span> yaradırsınız.</div>
  </div>
...
<form action="{{ route('admin.services.store') }}" method="post" enctype="multipart/form-data" class="row g-4">
  @csrf
      ...
      <div class="card-body p-3 p-md-4">
        <div class="row g-3">
          ...
          <div class="col-md-4">
            ...
            <div class="form-text">Bu bölmədə tip həmişə <b>service</b> olur.</div>
          </div>
