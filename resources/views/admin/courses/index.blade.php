    ...
    <div class="container-fluid py-3">
                ...
                <div class="input-group">
                    <div class="search-wrap w-100">
                        ...
                        <input type="search" name="q" value="{{ $q ?? '' }}" class="form-control"
                            placeholder="Ada və ya açıqlamaya görə axtar…" aria-label="Search courses">
                    </div>
                    @if (!empty($q))
                        <a href="{{ route('admin.courses.index') }}" class="btn btn-outline-secondary" title="Təmizlə"><i
        ...
        @if (!empty($q))
            <div class="alert alert-info py-2">
                Axtarış: <strong>{{ $q }}</strong> — <span class="text-muted">{{ $courses->total() }}
                    nəticə</span>
            </div>
        @endif
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex align-items-start gap-3">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            @if (!empty($c->description))
                                                <div class="small text-muted line-2">{{ strip_tags($c->description) }}
                                                </div>
                                            @endif
                                            @if ($c->courseUrl)
                                                <a href="{{ $c->courseUrl }}" target="_blank" rel="noopener"
                                ...
                                <td class="text-end">
                                    <div class="actions-wide btn-group" role="group" aria-label="Actions">
                                        <a class="btn btn-sm btn-outline-primary" href="{{ route('course-details', $c) }}"
                                            target="_blank">
                                    ...
                                    <div class="actions-compact dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a class="dropdown-item" href="{{ route('course-details', $c) }}"
                                                    target="_blank"><i class="bi bi-eye me-2"></i>Gör</a></li>
                                            <li><a class="dropdown-item" href="{{ route('admin.courses.edit', $c) }}"><i
        ...
        <div class="d-flex justify-content-between align-items-center mt-3">
            ...
            <div>{{ $courses->appends(['q' => $q])->links() }}</div>
        </div>
    </div>
