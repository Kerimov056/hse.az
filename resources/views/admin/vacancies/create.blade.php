...
<div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
  <div>
    <h1 class="mb-1">Yeni Vakansiya</h1>
    <div class="input-help">Bu hissədə yalnız <span class="badge bg-primary-subtle text-primary border border-primary badge-type">Vacancy</span> yaradırsınız.</div>
  </div>
...
<form action="{{ route('admin.vacancies.store') }}" method="post" enctype="multipart/form-data" class="row g-4">
  @csrf
  ...
  <div class="col-lg-8">
      ...
      <div class="card-body p-3 p-md-4">
        <div class="row g-3">
          <div class="col-md-4">
            ...
            <div class="form-text">Bu bölmədə tip həmişə <b>vacancy</b> olur.</div>
          </div>

          <div class="col-md-8">
            <label class="form-label">Ad *</label>
            <input type="text" name="name" class="form-control" required value="{{ old('name') }}" placeholder="Məs: Senior PHP Developer">
          </div>
    ...
    <div class="card shadow-sm mt-4">
      <div class="card-body p-3 p-md-4">
        ...
        <div class="row g-3">
          <div class="col-md-6"><label class="form-label">Twitter</label><input type="url" name="twitterurl"  class="form-control" value="{{ old('twitterurl')  }}" placeholder="https://x.com/..."></div>
          <div class="col-md-6"><label class="form-label">Facebook</label><input type="url" name="facebookurl" class="form-control" value="{{ old('facebookurl') }}" placeholder="https://facebook.com/..."></div>
          <div class="col-md-6"><label class="form-label">LinkedIn</label><input type="url" name="linkedinurl" class="form-control" value="{{ old('linkedinurl') }}" placeholder="https://linkedin.com/in/..."></div>
          <div class="col-md-6"><label class="form-label">Email</label><input type="text" name="emailurl" class="form-control" value="{{ old('emailurl') }}" placeholder="user@mail.com və ya mailto:user@mail.com"></div>
          <div class="col-md-6"><label class="form-label">WhatsApp</label><input type="text" name="whatsappurl" class="form-control" value="{{ old('whatsappurl') }}" placeholder="+994501112233 və ya https://wa.me/..."></div>
        </div>
      </div>
    </div>
