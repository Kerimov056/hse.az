...
@section('content')
            ...
            <div class="row td_gap_y_30">
                ...
                <div class="col-lg-8">
                    <div class="td_card td_style_1 td_radius_10">
                        @if ($service->imageUrl)
                            <img src="{{ $service->imageUrl }}" alt="{{ $service->name }}" class="w-100"
                                style="border-radius:10px 10px 0 0;object-fit:cover;max-height:420px;">
                        @endif
                            ...
                            <div class="td_card_info_in">
                                <div class="d-flex align-items-center justify-content-between td_mb_20">
                                    ...
                                    @if ($service->courseUrl)
                                        <a href="{{ $service->courseUrl }}" target="_blank" rel="noopener"
                        ...
                        <div class="td_card_info">
                            <div class="td_card_info_in">
                                ...
                                <ul class="td_mp_0 td_fs_18 td_heading_color td_mb_0">
                                    <li class="td_mb_10"><b>Category:</b>
                                        {{ $service->category->name ?? ($service->category ?? 'Service') }}</li>
                                ...
                                <div class="td_card_info">
                                    <div class="td_card_info_in">
                                        ...
                                        <div class="social-btns">
                                            @if ($twitter)
                                                <a class="social-btn btn-x" href="{{ $twitter }}" target="_blank"
                                            ...
                                            @if ($facebook)
                                                <a class="social-btn btn-fb" href="{{ $facebook }}" target="_blank"
                                            ...
                                            @if ($linkedin)
                                                <a class="social-btn btn-li" href="{{ $linkedin }}" target="_blank"
                                            ...
                                            @if ($emailLink)
                                                <a class="social-btn btn-mail btn-outline" href="{{ $emailLink }}"
                                                    aria-label="Email">
                                            ...
                                            @if ($waLink)
                                                <a class="social-btn btn-wa" href="{{ $waLink }}" target="_blank"
                                ...
                                <div class="td_card_info td_white_bg">
                                    <div class="td_card_info_in">
                                        ...
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('service-details', $rc->id) }}"
    ...
    @include('partials.info-toast', ['text' => $service->info ?? null])
