...
// info mətni (boşluqları kəsib)
$infoText = trim((string) $topic->info);
@endphp
...
.social-btn:hover{
    ...
    box-shadow:0 12px 28px rgba(14,19,42,.22)
}
.social-btn i{
    font-size:1rem
}
                ...
                <div class="side-card td_white_bg td_radius_10">
                    <div class="side-in">
                        ...
                        <ul class="td_mp_0 td_fs_18 td_heading_color td_mb_0">
                            <li class="td_mb_10">
                                <b>Category:</b>
                                {{ $topic->category->name ?? ($topic->category ?? 'Topic') }}
                            </li>
                            <li>
                                <b>Updated:</b>
                                {{ optional($topic->updated_at)->format('d.m.Y H:i') }}
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="td_card td_style_3 td_radius_10">
                            <a href="{{ route('topices-details', $rc->id) }}" class="td_card_thumb">
                                <img
                                    src="{{ $rc->imageUrl ?? asset('assets/img/placeholder/placeholder-800x500.jpg') }}"
                                    alt="{{ $rc->name }}"
...
{{-- INFO TOAST – yalnız info mətni boş deyilsə --}}
@include('partials.info-toast', ['text' => $topic->info])
